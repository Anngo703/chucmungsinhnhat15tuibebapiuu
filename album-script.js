document.addEventListener('DOMContentLoaded', () => {
  const message =
    "Hành trình của chúng ta bắt đầu từ ngày 20-8-2025. Mỗi khoảnh khắc bên nhau sẽ là một kỉ niệm đẹp đẽ anh sẽ mãi ghi nhớ từng khoảng khắc khi ở bên em, mỗi 1 phút ở bên em anh đều cảm thấy vui vẻ,một khắc bên em được nghe em tâm sụ được nghe những câu chuyện em kể , hiểu về em ,nghe 1 câu em yêu anh cũng đủ để khiến anh yêu em nhiều hơn, một kĩ niệm chính là viên gạch xây nên ngôi nhà hạnh phúc. Cùng nhau, chúng ta sẽ viết nên một câu chuyện tình yêu vĩnh cửu. ❤️";
